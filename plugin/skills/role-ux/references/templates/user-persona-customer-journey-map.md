...
> Verbatim conversion of the handbook DOCX template `assets/templates/**/user-persona-customer-journey-map.docx` (Vietnamese-first; keep `[ĐIỀN: ...]` placeholders that the user has not answered).

**POWER HOME · UX/UI DESIGNERUSER PERSONA & CUSTOMER JOURNEY MAPMASTER TEMPLATE · v1.0 · DRAFT**

| Trường | Giá trị kiểm soát |
|---|---|
| Mã tài liệu | [ĐIỀN: <TÊN DỰ ÁN>-51-v1.0-YYYYMMDD] |
| PIC duy nhất | UX (input từ PO, BA) |
...
|---|---|---|
| Dữ liệu user hiện có (survey, interview, analytics): [...] | [ĐIỀN: nội dung hoặc đường dẫn nguồn] | [CẦN XÁC NHẬN] |
| Phân khúc nghi là chính: [...] | [ĐIỀN: nội dung hoặc đường dẫn nguồn] | [CẦN XÁC NHẬN] |
| Nghiệp vụ / flow trọng tâm cần map: [...] | [ĐIỀN: nội dung hoặc đường dẫn nguồn] | [CẦN XÁC NHẬN] |
...
| Persona | Goal | Pain point | Behaviour | Evidence |
|---|---|---|---|---|
...
- Journey map theo góc nhìn của user, không phải quy trình nội bộ công ty
