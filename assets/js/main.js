...
const SHARED_UI_COPY = {
  en: {
    ...
    docReaderConfidential: 'CONFIDENTIAL — internal use only. Read here first; download only if you need the file.',
  ...
  vi: {
    ...
    docReaderConfidential: 'MẬT (CONFIDENTIAL) — chỉ dùng nội bộ. Đọc tại đây trước; chỉ tải khi thực sự cần file.',
...
// ============================================================
// DOCUMENT READER — confidential templates are read in-page first;
